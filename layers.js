...
var lyr_RT_3 = new ol.layer.Vector({
                ...
                popuplayertitle: "RT",
                interactive: true,
                title: '<img src="styles/legend/RT_3.png" /> RT'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_gadm41_IDNADM_ADM_4_1.setVisible(true);lyr_RW_2.setVisible(true);lyr_RT_3.setVisible(true);lyr_kebun_4.setVisible(true);lyr_lapangan_5.setVisible(true);lyr_irigasi_6.setVisible(true);lyr_jalan_7.setVisible(true);lyr_Clipped_8.setVisible(true);lyr_makam_9.setVisible(true);lyr_Clipped_10.setVisible(true);lyr_Point_11.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_gadm41_IDNADM_ADM_4_1,lyr_RW_2,lyr_RT_3,lyr_kebun_4,lyr_lapangan_5,lyr_irigasi_6,lyr_jalan_7,lyr_Clipped_8,lyr_makam_9,lyr_Clipped_10,lyr_Point_11];
...
lyr_RT_3.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', });
